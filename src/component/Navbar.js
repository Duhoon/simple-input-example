        ...
        <nav>
            <div className="nav-group">
                <div className="logo-wrapper" >
                    <NavLink to="/"><button className="btn-logo">ZET</button></NavLink>
                </div>
                <NavLink className="btn-nav" to="/" children={({isActive})=>{
                    return isActive ?
                        <>
                ...
                <NavLink className="btn-nav" to="/mypage" children={({isActive})=>{
                    return isActive ? 
                    <>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
                ...
                <NavLink className="btn-nav" to="/login" children={({isActive})=>{
                    return isActive ?
                    <>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
