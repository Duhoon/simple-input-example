...
const Message = (props)=>{
    ...
    const [numReplies, setNumReplies] = useState(props.message.numReplies);
    ...
    return (        
        ...
        {openUpdate ?
            ...
            :
            <p className="">
                {isReply? <span className="font-bold mr-2">↳</span>: null }
                {content}
            </p>
        }
            </Link> {/* Message Body */}
            ...
            <div className="message-tail flex mb-2 justify-evenly w-full">
                ...
                <div className="flex shrink-0">
                    ...
                    <span className="message-btn ml-2 pt-[3px]">{numReplies}</span>
                </div>
